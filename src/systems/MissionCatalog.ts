...
export const MISSION_CATALOG: Record<MissionId, MissionDef> = {
  ...
  'm1-rescue': {
    ...
    budget: 600,
    description: '救難信号を探知しました。ユニット間の通信を確立し、障害を排除して、救助に向かって下さい。',
    briefingText: '現在の交戦規程では、正当防衛・緊急避難以外での武器使用は認められていません。別令あるまで、注意して行動して下さい。',
    navigatorLines: [
      '救難信号を探知しました。',
      'ユニット間の通信を確立し、障害を排除して、救助に向かって下さい。',
      '交戦規程に従い、正当防衛・緊急避難以外での武器使用は控えて下さい。',
    ],
